...
const { getAllStudents,createClass,enroll,uploadFiles,applyWithdrawal,getFilesByClass,getClassStudents,getWithdrawals,updateStatusWithdrawal,getAllClasses } = require("../controllers/action.controllers");
